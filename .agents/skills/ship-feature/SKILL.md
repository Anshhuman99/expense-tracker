...
allowed-tools: view_file, run_command, call_mcp_tool
---

# ship-feature

Follow these steps to commit, push, create PR, merge, and clean up after a feature is complete.
...
Report: "✓ Committed — <generated-message>"
